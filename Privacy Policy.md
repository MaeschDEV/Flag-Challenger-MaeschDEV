...
This privacy policy is applicable to the Tik-Tak-Toe Party app (hereinafter referred to as "Application") for mobile devices, which was developed by MaeschDEV (hereinafter referred to as "Service Provider") as a a Free service. This service is provided "AS IS".
